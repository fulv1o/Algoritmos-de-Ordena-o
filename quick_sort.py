"""
quicksort recursivo baseado na abordagem de Nico Lomuto (pivô inicializado pela esquerda do vetor)
"""
import random
import time
import sys
# sys.setrecursionlimit(100000000) # (NÃO USAR, PODE TRAVAR O COMPUTADOR)
